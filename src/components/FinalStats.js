...
class FinalStats extends Component {
  getResultsMarkup(results) {
    return results.map((result, idx) => (
      <li className={`stats__result stats__result--${result}`} key={idx} />
    ))
  }
      ...
      return (
        <tr key={title}>
          ...
          <td className="result__extra">
            {value}
            <span className={`stats__result stats__result--${icon}`} />
          </td>
                  ...
                  <table className="result__table" key={resultNumber}>
                    <tbody>
                      ...
                      <tr>
                        <td
                          colSpan="5"
                          className="result__total  result__total--final"
                        >
                          {totalFinalPoints}
                        </td>
                      </tr>
                  ...
                  <table className="result__table" key={resultNumber}>
                    <tbody>
                      <tr>
                        ...
                        <td className="result__total  result__total--final">
                          fail
                        </td>
                      </tr>
                    </tbody>
